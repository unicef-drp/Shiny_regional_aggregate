...
CombineCountrySpecificRuns <- function(# Combine results of country-specific runs for all/some countries and
  ...
  if (get.combinedresults) {
    ...
    res.hivremoved.cqt.Lw.all <- res.crisisremoved.cqt.Lw.all <- 
      res.crisisandhivremoved.cqt.Lw.all <- res.logscale.hivremoved.cqt.Lw.all <- res.cqt.Lw.all
    ...
    files <- c("year.t", "res.cqt.Lw", "resall.cqt.Lw", "resmean.ct.Lw", "resARR.cq.Lwy",
               ...
               "res.logscale.hivremoved.cqt.Lw")
    if (get.trajectories)
    ...
    for (c in 1:C) {
      ...
      for (w in 1:nweightsplus1) {
        ...
        res.crisisremoved.cqt.Lw.all[[w]][c, , is.element(year.all, year.t)] <- res.crisisremoved.cqt.Lw[[w]][1, , ]
        res.crisisandhivremoved.cqt.Lw.all[[w]][c, , is.element(year.all, year.t)] <- res.crisisandhivremoved.cqt.Lw[[w]][1, , ]
    ...
    res.crisisremoved.cqt.Lw <- res.crisisremoved.cqt.Lw.all
    res.crisisandhivremoved.cqt.Lw <- res.crisisandhivremoved.cqt.Lw.all
    ...
    if (file.exists(file.path(output.dir.countryspecific, 
      ...
      files <- c("res.cqt.Lw", "resall.cqt.Lw", "resmean.ct.Lw", "resARR.cq.Lwy",
                 ...
                 "res.crisisandhivremoved.cqt.Lw", "res.logscale.hivremoved.cqt.Lw")
      ...
      for (c in 1:C) {
        ...
        for (w in 1:nweightsplus1) {
          ...
          res.hivremoved.cqt.Lw.all[[w]][c, , is.element(year.all, year.t)] <- res.hivremoved.cqt.Lw[[w]][1, , ]
          res.crisisremoved.cqt.Lw.all[[w]][c, , is.element(year.all, year.t)] <- res.crisisremoved.cqt.Lw[[w]][1, , ]
          res.crisisandhivremoved.cqt.Lw.all[[w]][c, , is.element(year.all, year.t)] <- res.crisisandremoved.cqt.Lw[[w]][1, , ]
          res.logscale.hivremoved.cqt.Lw.all[[w]][c, , is.element(year.all, year.t)] <- 
            res.logscale.hivremoved.cqt.Lw[[w]][1, , ]
          resmean.ct.Lw.all[[w]][c, is.element(year.all, year.t)] <- unlist(resmean.ct.Lw[[w]][1, ])
          for (y in 1:length(ARR.years)) {
      ...
      save(res.crisisremoved.cqt.Lw, file = file.path(output.dir, "res.crisisremoved.cqt.Lw(upto2000).rda"))
      save(res.crisisandhivremoved.cqt.Lw, file = file.path(output.dir, "res.crisisandhivremoved.cqt.Lw(upto2000).rda"))
      save(res.logscale.hivremoved.cqt.Lw, 
