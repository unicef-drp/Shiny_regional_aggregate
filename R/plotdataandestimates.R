...
PlotDataAndEstimates <- function(# Plot data, estimated fits and uncertainty intervals.
  ...
  zoom.year.end = 2018, ##<< Last year of zoom range for zoom plot.
...
PlotLegend <- function(# Plot legend.
  ...
  cex=ifelse(length(legendtext.s)>20,1.5-length(legendtext.s)/100,1.5) # add by YS, if >30: 1; if 20~30, 1.2;if <20,1.5
