...
workdir <- "C:/Users/dsharrow/Dropbox/IGME Data/2017 Round Estimation/Code" # Give work directory file path if not running things on server
...
#----------------------------------------------------------------------
runname.U5MR <- "GR20170401_all"
runname.IMR <- "IMR20170404_all"
runname.NMR <- "NMR_tempfortesting"
...
OutputAggregates(results.U5MR.file = file.path("output", runname.U5MR, "Results.csv"),
                 ...
                 output.dir = file.dir.median,
                 year.target = 2016.5, est.years = seq(1950.5,2016.5,1),
                 regiontypes.select = "NewUnicef") ## add livebirths.file? "input/Results_IMR_Final_20130812.csv"
# Total (UIs)
