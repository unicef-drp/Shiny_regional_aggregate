...
ChooseRegion <- function(
  ...
  if (regiontype == "UNICEFRegion") {
  ...
  } else if (regiontype == "NewUnicefRegion") {
   ...
   r <- ChooseSDGRegion(region)
    ...
    stop("regiontype must be one of UNICEFRegion, UNICEFRegionSSA, MDGRegion, WBRegion, UNPDRegion, OICRegion M49Region or SDGRegion.")
  }
  return(r)
}
#----------------------------------------------------------------------
