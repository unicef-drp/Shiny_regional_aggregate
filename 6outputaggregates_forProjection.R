...
projections<-list.files("C:/Users/dsharrow/Dropbox/UN IGME data/2019 Round Estimation/Code/Projections/Input")
#projections<-projections[1]
#projections<-c("SDG","AdjARR","HighIncome","Constant") #"Constant Rate 2017"
projections <- projections[c(5,6)]
for(projection in projections){
file.dir.median <- file.path(paste0("Projections/Output/",projection," Aggregate results (median) ",date ))
year.lastestimatepublished <- 2030.5#
...
OutputAggregates(results.U5MR.file = paste0("Projections/Input/",projection,"/","Results_U5MR.csv"),
                results.IMR.file = paste0("Projections/Input/",projection,"/","Results_IMR.csv"),
                results.NMR.file = paste0("Projections/Input/",projection,"/","Results_NMR.csv"),
                 run.on.server = run.on.server,
                 year4 = year.lastestimatepublished,
                 output.dir = file.dir.median,
                 year.target = year.lastestimatepublished, est.years = seq(1950.5,2050.5,1),
                 test=FALSE,
                 get.world.results = TRUE,
                 round.output = FALSE,
                 regiontypes.select = c("UNICEFReport", "SDGSimple","M49"),
