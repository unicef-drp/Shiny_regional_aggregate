...
dirnew <- file.path(file.path("median_results_total_5_14/Rates & Deaths(ADJUSTED)_SDGSimpleRegion.csv"))
dt1 <- read.region.summary(dirold)
dt2 <- read.region.summary(dirnew)
...
dirnew <- file.path(file.path("median_results_total_15_24/Rates & Deaths(ADJUSTED)_SDGSimpleRegion.csv"))
dt1 <- read.region.summary(dirold)
dt2 <- read.region.summary(dirnew)
